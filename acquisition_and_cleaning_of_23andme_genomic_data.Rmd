...
ggplot(file_type, aes(combined_file_type)) + geom_bar() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
ggplot(file_type, aes(combined_file_type_of_member)) + geom_bar() + theme(axis.text.x = element_text(angle = 45, hjust = 1))
...
wide_df %>% filter(archive_content == "name_is_genome_mumble_txt") %>% select(member_name)
```
